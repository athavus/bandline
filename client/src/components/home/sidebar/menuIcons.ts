export const menuIcons = {
  favorites: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" stroke="currentColor" stroke-width="2" />
  </svg>`,

  history: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" />
    <polyline points="12,6 12,12 16,14" stroke="currentColor" stroke-width="2" />
  </svg>`,

  playlists: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    <path d="M21 15V6" stroke="currentColor" stroke-width="2" />
    <path d="M21 3h-6" stroke="currentColor" stroke-width="2" />
    <path d="M5 17a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" stroke="currentColor" stroke-width="2" />
  ...
  logout: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" stroke="currentColor" stroke-width="2" />
    <polyline points="16,17 21,12 16,7" stroke="currentColor" stroke-width="2" />
    <line x1="21" y1="12" x2="9" y2="12" stroke="currentColor" stroke-width="2" />
  </svg>`,

  login: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none">
  ...
  register: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none">
  ...
  charts: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none">
