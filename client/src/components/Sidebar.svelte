...
<aside class="sidebar" class:open>
  ...
  <div class="sidebar-content">
    {#if authState.isAuthenticated}
      ...
      <div class="sidebar-section">
        <div class="user-info">
          ...
          <div class="user-details">
            <span class="user-name">{authState.user?.username || 'Usuário'}</span>
      ...
      <div class="sidebar-section">
        ...
        <nav class="sidebar-menu">
          ...
          <button class="menu-item danger" on:click={() => handleAction('logout')}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    ...
    {:else}
      ...
      <div class="sidebar-section">
        <nav class="sidebar-menu">
          <button class="menu-item primary" on:click={() => handleAction('login')}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
          ...
          <button class="menu-item secondary" on:click={() => handleAction('register')}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
