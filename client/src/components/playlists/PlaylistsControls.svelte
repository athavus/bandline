<script lang="ts">
    ...
    import PlaylistsStats from "./PlaylistsStats.svelte";
    import PlaylistsSearch from "./PlaylistsSearch.svelte";
    import PlaylistsSortView from "./PlaylistsSortView.svelte";

    export let totalAlbums: number;
...
<div class="controls-bar">
    <PlaylistsStats {totalAlbums} {filteredCount} />

    <PlaylistsSearch bind:value={searchQuery} on:clear={handleClearSearch} />
